...
public class PaymentController {
    ...
    public String paymentNotification(final Model model,
                                      ...
                                      @RequestParam(name = "providerReferenceId") final String providerReferenceId) {


        ;

        model.addAttribute("response", paymentService.getStatus(code,transactionId,merchantId,providerReferenceId));
